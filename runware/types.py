...
class IControlNetHandsAndFace(IControlNetGeneral):
    include_hands_and_face_open_pose: Optional[bool] = None
...
class IControlNetBaseWithUUID(ABC):
    ...
    control_mode: Optional[EControlMode] = None
    guide_image: Optional[Union[str, File]] = None
    guide_image_uuid: Optional[str] = None
    guide_image_unprocessed: Optional[Union[str, File]] = None
