...
TIMEOUT_DURATION = 240000  # 120 seconds
...
GetWithPromiseCallBackType = Callable[
    [Callable[[Any], None], Callable[[Exception], None], Any],
    bool
]

def remove_listener(emitter: Any, event_name: str, callback: Callable) -> None:
    """
    Safely remove a listener from your emitter-like object.
    This method must be adapted to your actual emitter (e.g., a WebSocket or custom event bus).
    """
    try:
        emitter.remove_listener(event_name, callback)
    except Exception:
        pass  # or log, if you want
