...
- `teaCacheStartStep` and `teaCacheStopStep` are integers that represent the start and end steps of the teaCache process.
  - `teaCacheStartStep` is the step at which the teaCache process starts, and `teaCacheStopStep` is the step at which the teaCache process ends.
